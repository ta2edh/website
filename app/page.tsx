      ...
      <main className="flex-1 container mx-auto px-4 py-6 md:py-8 flex flex-col justify-center sm:px-6 lg:px-8 w-full">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid gap-6 md:grid-cols-2 w-full">
            {/* Left Column - Intro */}
            <div className="bg-[#050a0f] border border-green-900/60 rounded-lg p-6 space-y-5 shadow-lg shadow-green-900/10 w-full sm:px-6 lg:px-8 w-full">
            ...
            <div className="bg-[#050a0f] border border-green-900/60 rounded-lg p-6 shadow-lg shadow-green-900/10 w-full sm:px-6 lg:px-8 w-full">
              <div className="flex items-center gap-3 mb-4">
                <div className="h-3 w-3 rounded-full bg-green-500 animate-pulse"></div>
